...
class __Mustache_11ff1b83a9aefd994f1b35bc82ba148c extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section59f5011a2f2a085932bd58360b896567($context, $indent, $value);
        $buffer .= $indent . '        </tbody>
';
        $buffer .= $indent . '    </table>
';
...
';
    ...
    private function sectionC137737333af8782a401cde7c95a7211(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                                <a data-action="view-day-link" href="#" class="day" aria-label="';
...
';
    ...
    private function sectionB460f67d08a6259a54e174055561888e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionC137737333af8782a401cde7c95a7211($context, $indent, $value);
...
';
    ...
    private function section59f5011a2f2a085932bd58360b896567(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionB460f67d08a6259a54e174055561888e($context, $indent, $value);
                // 'postpadding' section
