...
/**
 * Strings for component 'format_kickstart', language 'fr', branch 'MOODLE_38_STABLE'
 *
...
$string['buypromaxtemplates'] = 'Vous utilisez le nombre maximum (<b>3</b>) de modèles autorisés dans l\'édition gratuite de Kickstart. Pour créer plus de modèles, achetez <a target="_blank" href="https://bdecent.de/products/moodle-plugins/kickstart-course-wizard-pro/">Kickstart Pro</a>.';
...
$string['defaultteacherinstructions_default'] = '<p>Actuellement, il n\'y a rien ici, alors commencez à ajouter votre contenu. Si vous avez besoin d\'aide, voici un didacticiel vidéo sur toutes les options dont vous disposez. Nous avons simplifié la création de cours pour vous. Tout d\'abord, vous choisissez un modèle qui convient à votre cours, puis vous pouvez commencer à ajouter du contenu.</p>';
...
$string['notemplates'] = 'Aucun modèle n\'a encore été créé.';
