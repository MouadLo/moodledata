...
/**
 * Strings for component 'theme_boost_campus', language 'fr', branch 'MOODLE_38_STABLE'
 *
...
$string['courseeditbuttonsetting'] = 'Bouton de modification du cours';
$string['courseeditbuttonsetting_desc'] = 'Avec ce paramètre, vous pouvez ajouter un bouton marche / arrêt d\'édition de cours supplémentaire à l\'en-tête du cours pour une accessibilité plus rapide de cette fonction souvent utilisée.';
...
$string['privacy:metadata'] = 'Le thème Boost Campus ne stocke aucune donnée personnelle sur un utilisateur.';
